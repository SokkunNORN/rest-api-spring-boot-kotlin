...
class ParticipantController(
    ...
    @PostMapping
    fun createParticipant(@RequestBody participantReq: ParticipantReq): Participant =
        participantService.createParticipant(participantReq)

    @PutMapping("/{id}")
    fun updateParticipant(@PathVariable id: Long, @RequestBody participantReq: ParticipantReq): Participant? =
        participantService.updateParticipant(id, participantReq)
}